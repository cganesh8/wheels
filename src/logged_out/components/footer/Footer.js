...
const infos = [
  {
    icon: <PhoneIcon />,
    description: "1800 069 967"
  },
  {
    icon: <MailIcon />,
    description: "admin@teachme2drive.com.au"
  }
];
...
const socialIcons = [
  ...
  //},
  {
    ...
    href: "https://www.facebook.com/pg/TM2Drive/reviews/?ref=page_internal"
  },
  {
    icon: (
      <svg
    ...
    label: "GoogleReviews",
    href: "https://g.page/TM2Drive/review?rc"
  },
  //{
  //  icon: (
  //    <svg
